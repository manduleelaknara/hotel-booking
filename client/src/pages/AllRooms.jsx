...
const AllRooms = () => {
    ...
    const { rooms, navigate, currency, backendUrl } = useAppContext(); 
    ...
    const priceRanges = ['0 to 10000', '10000 to 25000', '25000 to 50000', '50000 to 100000'];
                ...
                {filteredRooms.map((room) => (
                    <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                        <img
                            ...
                            src={`${backendUrl}${room.images[0]}`} alt="hotel-img" title='View Room Details'
